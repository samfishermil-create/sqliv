# SQLiv v2.0 - cleaned and syntax-fixed
...
def singlescan(url):
    ...
    if has_query:
        ...
        if result:
            ...
            # print newline (works on py2/py3)
            try:
                sys.stdout.write("\n")
            except Exception:
                pass
...
def main():
    ...
    if args.dork is not None and args.engine is not None:
        ...
        # If user wants to continue crawling, crawl the first vulnerable url as seed
    ...
    # scan SQLi of given site (single target, no reverse)
...
if __name__ == "__main__":
    ...
    raise SystemExit(main())# crawler instance
crawler = Crawler()
...
def singlescan(url):
    ...
    if urlparse(url).query != '':
        ...
        if result:
            ...
            # move carriage return to newline
            try:
                sys.stdout.write("\n")
            except Exception:
                pass
